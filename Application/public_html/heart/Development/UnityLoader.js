...
(function() {
 var loadPackage = function(metadata) {
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 13992939;
      var PACKAGE_UUID = '27856258-a222-4800-bf13-716b8793c112';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 20308, 0, 0).open('GET', '/globalgamemanagers');
    new DataRequest(20308, 31192, 0, 0).open('GET', '/globalgamemanagers.assets');
    new DataRequest(31192, 44692, 0, 0).open('GET', '/level0');
    new DataRequest(44692, 44711, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(44711, 44730, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(44730, 11589082, 0, 0).open('GET', '/sharedassets0.assets');
    new DataRequest(11589082, 12992518, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(12992518, 13885554, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(13885554, 13965314, 0, 0).open('GET', '/Resources/unity_builtin_extra');
    new DataRequest(13965314, 13992939, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
